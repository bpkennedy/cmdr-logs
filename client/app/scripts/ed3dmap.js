...
var Ed3d = {
  ...
  'init' : function(options) {
    ...
    $.when(
        ...
        $.getScript(Ed3d.basePath + "scripts/components/grid.class.js"),
        $.getScript(Ed3d.basePath + "scripts/components/icon.class.js"),
        $.getScript(Ed3d.basePath + "scripts/components/hud.class.js"),
        $.getScript(Ed3d.basePath + "scripts/components/action.class.js"),
        $.getScript(Ed3d.basePath + "scripts/components/route.class.js"),
        $.getScript(Ed3d.basePath + "scripts/components/system.class.js"),
        $.getScript(Ed3d.basePath + "scripts/components/galaxy.class.js"),
